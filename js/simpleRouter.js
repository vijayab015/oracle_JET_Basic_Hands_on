...
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 
    'ojs/ojbutton','ojs/ojrouter','ojs/ojmodule',
    'ojs/ojtoolbar', 'ojs/ojfilepicker','ojs/ojavatar','ojs/ojnavigationlist'], // add additional JET component modules as needed
  // eslint-disable-next-line no-unused-vars
  function (oj, ko, $) { // this callback gets executed when all required modules are loaded
      ...
      router.configure({
//         " home":{label:'Home',value:'<h3>Oracle Home<h3>',isDeafult:true},
//         " customers":{label:'Customers',value:'<h3>GE,Accenture,MHI<h3>'},
//         " about":{label:'About us',value:'<h3>contact@oracle.com<h3>'}
     "chap1":{label:'Chapter 1',value:'chapter1',isDefault:true},
     "chap2":{label:'Chapter 2',value:'chapter2'}
      })
