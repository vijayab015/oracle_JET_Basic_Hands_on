...
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout',
    'ojs/ojinputtext','ojs/ojcheckboxset','ojs/ojradioset',"ojs/ojformlayout"], // add additional JET component modules as needed
  // eslint-disable-next-line no-unused-vars
  function (oj, ko, $) { // this callback gets executed when all required modules are loaded
      // add any startup code that you want here
      
      function MyModel(){
          self.uName=ko.observable("demo");
          self.pwd=ko.observable();
          self.selectedLoc=ko.observableArray();
