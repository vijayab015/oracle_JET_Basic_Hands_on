...
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 
    'ojs/ojbutton','ojs/ojbutton',
    'ojs/ojtoolbar', 'ojs/ojmodule','ojs/ojfilepicker','ojs/ojavatar'], // add additional JET component modules as needed
  // eslint-disable-next-line no-unused-vars
  function (oj, ko, $) { // this callback gets executed when all required modules are loaded
    ...
    
      {
        ...
        self.selectedChap=ko.observable('chapter1');  
